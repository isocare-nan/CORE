<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_recvperiod_rmembgroupcode_rmembno_news.aspx.cs" 
Inherits="Saving.Criteria.u_cri_coopid_recvperiod_rmembgroupcode_rmembno_news" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
		...
		<script type="text/javascript">
		    ...
		    function OnDwItemChanged(s, r, c, v) {
		        var zero = new Padder(8);
		        if (c == "start_membno") {

		            //alert(zero.pad(v));
		         //   objdw_criteria.SetItem(1, "start_membno", "000");
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientEventItemChanged="OnDwItemChanged" ClientEventClicked="OnDwItemClick">
