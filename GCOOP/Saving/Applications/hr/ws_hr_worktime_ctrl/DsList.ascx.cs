    ...
    public partial class DsList : DataSourceRepeater
    {
        ...
        public void SetTimeAfRetrieve() {
            for(int r =0; r< this.RowCount;r++){
                ...
                this.DATA[r].START_MINUTE = Convert.ToInt16("00");
                this.DATA[r].END_HOUR = Convert.ToInt16("16");
                this.DATA[r].END_MINUTE = Convert.ToInt16("00");
        ...
        {
            string sql = @"
                select he.emp_no,mp.prename_desc,he.emp_name,he.emp_surname,ht.start_time,
                       ht.end_time,ht.worktime_code,ht.work_date
