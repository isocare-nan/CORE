    ...
    <EditItemTemplate>
        ...
        <table class="DataSourceFormView">
            <tr>
                ...
                <td width="20%">
                    <div>
                        <span style="text-align: center;">ยอดรวมปันผลเฉลี่ยคืน</span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="sum_divavg" runat="server" Style="text-align: right;" ToolTip="#,##0.00" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
