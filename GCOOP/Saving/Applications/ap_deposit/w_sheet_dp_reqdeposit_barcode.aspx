<%@ Page Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_sheet_dp_reqdeposit_barcode.aspx.cs"
    Inherits="Saving.Applications.ap_deposit.w_sheet_dp_reqdeposit_barcode" Title="Untitled Page" %>
    ...
    <script type="text/javascript">
        ...
        function SheetLoadComplete() {
            ...
            if (Gcoop.GetEl("HdSaveAccept").value == "true") {
                ...
                Gcoop.OpenIFrame(450, 150, "w_iframe_dp_printfirstpage_2.aspx", "?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo);
            }
            if (Gcoop.GetEl("HdIsPostBack").value != "true") {
                Gcoop.SetLastFocus("deptpassbook_no_0");
                Gcoop.Focus();
            }
        }
        ...
        function GetDeptNoFromDlg(deptaccount_no) {
            ...
            objDwMain.SetItem(1, "tran_bankacc_no", deptaccount_no);
            objDwMain.AcceptText();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Width="680px">
        ...
        <dw:WebDataWindowControl ID="DwMain" runat="server" DataWindowObject="d_dp_reqdepoist_main_barcode"
