...
//                alert(deptTypeCode);
                Gcoop.OpenIFrame(500, 180, "w_dlg_dp_booknew.aspx", "?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo + "&deptTypeCode=" + deptTypeCode + "&seqNo=" + seqNo);
            }
        }
...
//            alert(deptPassBookNo)
            ...
            //alert(deptPassBookNo);
            Gcoop.OpenIFrame(450, 110, "w_iframe_dp_printfirstpage_nan.aspx", "?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo);
        }
