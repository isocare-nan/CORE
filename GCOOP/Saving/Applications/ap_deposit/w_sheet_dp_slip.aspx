    ...
    <script type="text/javascript">
        ...
        function GetValueCheckApv(valueCheckApv, nameApv) {
            if (valueCheckApv == "success") {
                ...
                //bee barcode
                if (Gcoop.GetEl("HdColumFocus").value == "0") {
                    Gcoop.SetLastFocus("deptformat_0");
                } else {
                    Gcoop.SetLastFocus("passbook_0");
                }
                Gcoop.Focus();
                Gcoop.RemoveIFrame();
            }
        ...
        //bee barcode
        function NewPassbookNo(coopid, passbookno) {
            objDwMain.SetItem(1, "passbook", Gcoop.Trim(passbookno));
            Gcoop.GetEl("HfCoopid").value = coopid + "";
            objDwMain.AcceptText();
            if (Gcoop.GetEl("HfCheck").value == "True") {
                setCoopname();
        ...
        function OnDwMainItemChanged(s, row, c, v) {
            ...
            if (c == "deptformat") {
                ...
                Gcoop.GetEl("HdColumFocus").value = "0"
                ...
                //bee barcode
                Gcoop.GetEl("HdColumFocus").value = "1"
                objDwMain.SetItem(1, "passbook", Gcoop.Trim(v));
                var coopid = s.GetItem(1, "deptcoop_id");
                var passbook = s.GetItem(1, "passbook");
                s.AcceptText();
                NewPassbookNo(coopid, passbook);
                return 0;                
...
//                    return 1;
//                } else
//                 if (deptWithFlag == null || deptWithFlag == "") {
//                    alert("กรุณาเลือก \"ทำรายการ\" ก่อน");
//                    return 1;
...
//                Gcoop.Focus();
            ...
            if (printFlag == "true") {
                ...
                var other_amt = Gcoop.GetEl("HdOther").value;

                var control2 = Gcoop.GetEl("Hdcontrol2").value;

                
                if (argPrintBook != "") {
                    //PRINTBOOK-DOYS
                    //by_max
                    Gcoop.OpenIFrame(900, 550, "w_dlg_dp_printbook.aspx", "?deptAccountNo=" + argPrintBook + "&other_amt=" + other_amt + "&control=" + control2);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:HiddenField ID="HdOther" runat="server" />
    ...
    <asp:HiddenField ID="Hdcontrol2" runat="server" />
</asp:Content>
