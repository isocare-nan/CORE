    ...
    public partial class SLSLIPPAYOUTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "  SELECT  \'        \' as slip_tdate,   \r\n         \"MBUCFPRENAME\".\"PRENAME_DESC\",  " +
                ...
                " FROM \"SLSLIPPAYOUT\",   \r\n         \"MBMEMBMASTER\",   \r\n         \"MBUCFPRENAME\", " +
                "  \r\n         \"MBUCFMEMBGROUP\",   \r\n         \"LNCONTMASTER\"  \r\n   WHERE ( \"SLSLIP" +
                "PAYOUT\".\"MEMBGROUP_CODE\" = \"MBUCFMEMBGROUP\".\"MEMBGROUP_CODE\" ) and  \r\n         (" +
                " \"SLSLIPPAYOUT\".\"MEMCOOP_ID\" = \"MBUCFMEMBGROUP\".\"COOP_ID\" ) and  \r\n         ( \"S" +
                "LSLIPPAYOUT\".\"MEMCOOP_ID\" = \"MBMEMBMASTER\".\"COOP_ID\" ) and  \r\n         ( \"SLSLIP" +
                "PAYOUT\".\"MEMBER_NO\" = \"MBMEMBMASTER\".\"MEMBER_NO\" ) and  \r\n         ( \"MBMEMBMAST" +
                "ER\".\"PRENAME_CODE\" = \"MBUCFPRENAME\".\"PRENAME_CODE\" ) and  \r\n         ( \"SLSLIPPA" +
                "YOUT\".\"CONCOOP_ID\" = \"LNCONTMASTER\".\"COOP_ID\" ) and  \r\n         ( \"SLSLIPPAYOUT\"" +
                ".\"LOANCONTRACT_NO\" = \"LNCONTMASTER\".\"LOANCONTRACT_NO\" ) and  \r\n         ( slslip" +
                "payout.coop_id = :as_coopid ) AND  \r\n         ( slslippayout.payoutslip_no = :as" +
                "_payoutno )    \r\n";
