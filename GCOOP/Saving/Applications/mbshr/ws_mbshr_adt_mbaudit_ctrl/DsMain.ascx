    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            <tr>
                ...
                <td width="12%">
                    <div>
                        <span style="font-size: 12px;">สังกัดย่อย:</span>
                    </div>
                </td>
                <td width="22%">
            ...
            <tr>
                <td>
                        <div>
                                <span style="font-size: 12px;">ประเภทสมัคร:</span>
                        </div>
                 </td>
                 <td>
                        <asp:DropDownList ID="appltype_code" runat="server" Style="font-size: 12px;"></asp:DropDownList>
                </td>
                <td>
                        <div>
                                <span style="font-size: 12px;">วันที่บำเหน็จ:</span>
                        </div>
                 </td>
                 <td>
                        <asp:TextBox ID="recvbumnat_date" runat="server" Style="font-size: 12px; text-align: center;"></asp:TextBox>
                </td>
                <td>
                        <div>
                                <span style="font-size: 12px;">เงินบำเหน็ญ:</span>
                        </div>
                 </td>
                 <td>
                        <asp:TextBox ID="recvbumnat_amt" runat="server" Style="font-size: 12px; text-align: right;" 
            ...
            <td>
                        <div>
                                <span style="font-size: 12px;">หน่วยรับเงินปันผล:</span>
                        </div>
                 </td>
                 <td>
                        <asp:DropDownList ID="membgroup_dvd" runat="server" Style="font-size: 12px; text-align: right;" 
                        ToolTip="#,##0.00" ></asp:DropDownList>
                </td>
            <td>
                        <div>
                                <span style="font-size: 12px;">วันที่ลาออก:</span>
                        </div>
                 </td>
                 <td>
                        <asp:TextBox ID="resign_date" runat="server" Style="font-size: 12px; text-align: center;"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="2" rowspan="3">
                    <table>
                        ...
                        <tr>
                         <td>
                                <asp:CheckBox ID="reqresign_flag" runat="server" />งดการลาออก
                            </td>
                        </tr>
                    </table>
                </td>
