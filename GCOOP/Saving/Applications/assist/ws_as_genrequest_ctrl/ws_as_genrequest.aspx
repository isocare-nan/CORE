...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnDsMainItemChanged(s, r, c, v) {
            ...
            else if (c == "reqdate_flag") {
            dsMain.SetItem(0, "reqdate_flag", v);
            }
            else if (c == "sort_order") {
                dsMain.SetItem(0, "all_check", 0);
                JsSearchaccount();
            }
        }
        ...
        function OnDsListItemChanged(s, r, c, v) {
            if (c == "choose_flag") {
                ...
                var moneytype_code = dsMain.GetItem(0, "moneytype_code");
                var coop_id = document.getElementById('<%= Hd_coopid.ClientID %>').value;
                if (coop_id == "056001") {
                    ...
                    if (moneytype_code == "TRN" || moneytype_code == "CBT") {
                        if (account_no == "-") {
                            alert("ทะเบียน " + member_no + " ไม่มีเลขบัญชี กรุณาตรวจสอบ !!");
                            dsList.SetItem(r, "choose_flag", 0);
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:HiddenField ID="Hd_coopid" runat="server" />
</asp:Content>
