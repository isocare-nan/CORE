    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td width="13%">
                    <asp:DropDownList ID="trtype_code" runat="server" >
                        ...
                        <asp:ListItem Value="ASS01">บัญชีสวัสดิการ</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
             ...
             <tr>
                <td>
                    <span>วันที่บันทึกคำขอ:</span>
                </td>
                <td align = "center" >
                   <asp:DropDownList ID="reqdate_flag" runat="server" >
                        <asp:ListItem Value= "1" >วันที่ทำรายการ</asp:ListItem>
                        <asp:ListItem Value= "2" >วันเกิดสมาชิก</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
        ...
        <table class="DataSourceFormView">
            <tr>
                ...
                <td width="15%">
                    <span>การเรียงข้อมูล :</span>
                </td>
                <td width="15%">
                    <asp:DropDownList ID="sort_order" runat="server">
                        <asp:ListItem Value="1" Text="เรียงตามวันเกิดสมาชิก"></asp:ListItem>
                        <asp:ListItem Value="2" Text="เรียงตามเลขทะเบียนสมาชิก"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
