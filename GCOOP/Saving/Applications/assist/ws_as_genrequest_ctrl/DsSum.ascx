...
<asp:FormView ID="FormView1" runat="server" DefaultMode="Edit" 
    ...
    <EditItemTemplate>
    <table cellspacing="0" rules="all" class="DataSourceFormView" border="0" style="border-collapse: collapse; width:800px"> 
    <td style="border-style: none;background-color:#FFFF99; text-align: right; font-size:14px;" width="16%">
        ...
        <td width="16%" style="border-style: none;">
                 ...
                 <td style="border-style: none;background-color:#FFFF99; text-align: right; font-size:14px;" width="39%">
