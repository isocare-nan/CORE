...
<asp:Panel ID="Panel" runat="server" >
    ...
    <div style="overflow-y: scroll; overflow-x: hidden; height: 570px; width: 800px">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        ...
                        <td width="5%">
                            <asp:TextBox ID="num" runat="server" Style="text-align: center;" ReadOnly="true" ToolTip="#,##0"></asp:TextBox>
                        </td>
                        <td width="8%">
                        ...
                        <td width="10%">
                            <asp:TextBox ID="birth_date" runat="server" Style="text-align: center;" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td width="5%">
...
<center>
    <table  class="tbPage" width=" 800px">
        <tr>
            <td style="width: 20px">
