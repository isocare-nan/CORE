...
namespace Saving.Applications.assist.ws_as_ucfassisttype_ctrl
{
    public partial class DsDetail : DataSourceFormView
    {
        ...
        public void DdAssistGrp()
        {
            ...
            String sql = @"select assisttype_group,assisttype_group ||'-'|| assisttype_groupdesc as display from assucfassisttypegroup  where assisttype_group != '07' order by assisttype_group";
