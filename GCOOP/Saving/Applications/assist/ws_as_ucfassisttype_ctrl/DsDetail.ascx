        ...
        <table class="DataSourceFormView">
          ...
          <%--       
                ...
                <asp:DropDownList ID="membdate_flag" runat="server">
                        <asp:ListItem Value="0">ไม่ตรวจวันเป็นสมาชิก</asp:ListItem>
                        <asp:ListItem Value="1">เป็นสมาชิกก่อนวันที่ </asp:ListItem>
                        <asp:ListItem Value="2">เป็นสมาชิกตั้งแต่วันที่ </asp:ListItem>
                    </asp:DropDownList>
                    </td>
            ...
            <tr>
              <td>
                ...
                <td >
                    <asp:DropDownList ID="date_flag" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="stmpay_type" runat="server">
                        <asp:ListItem Value="0" Text="รับตามช่วงเดือน(ตรงวันเกิด)"></asp:ListItem>
