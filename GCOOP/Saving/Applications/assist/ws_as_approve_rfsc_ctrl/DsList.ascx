<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsList.ascx.cs" Inherits="Saving.Applications.assist.ws_as_approve_rfsc_ctrl.DsList" %>
...
<div style="overflow-y: scroll; overflow-x: hidden;  width: 900px">
   <table cellspacing="0" rules="all" class="DataSourceRepeater" style="width: 900px;
            border-collapse: collapse;">
