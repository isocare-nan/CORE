    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td style="width: 12%">
                    <div>
                        <span>วันที่ สสค:</span>
                    </div>
                </td>
                <td style="width: 23%">
                    <asp:TextBox ID="deptopen_date" runat="server" Style="text-align: center; background-color: #FFFF99;" ReadOnly="True"></asp:TextBox>
                </td>
                <td style="width: 12%">
                    <div>
                        <span>หักชำระ:</span>
                ...
                <td style="width: 23%">
                    <asp:TextBox ID="prncbal" runat="server" Style="text-align: right; "  BackColor=" #FFFF99" ToolTip="#,##0.00" 
