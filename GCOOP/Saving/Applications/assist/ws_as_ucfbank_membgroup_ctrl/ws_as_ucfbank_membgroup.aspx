<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_as_ucfbank_membgroup.aspx.cs" Inherits="Saving.Applications.assist.ws_as_ucfbank_membgroup_ctrl.ws_as_ucfbank_membgroup" %>
                ...
                <asp:TemplateField HeaderText="ชื่อสังกัด" ItemStyle-Width="30%">
                    <ItemTemplate>
                        <asp:TextBox ID="membgroup_desc" class="description" runat="server"  Text='<%# Bind("membgroup_desc") %>'
                           ...
                           <asp:TemplateField HeaderText="ธนาคาร" ItemStyle-Width="20%">
                    <ItemTemplate>
