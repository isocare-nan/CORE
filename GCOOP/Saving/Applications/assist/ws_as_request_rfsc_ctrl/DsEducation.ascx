<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsEducation.ascx.cs"
    Inherits="Saving.Applications.assist.ws_as_request_rfsc_ctrl.DsEducation" %>
        ...
        <table class="DataSourceFormView">
            <tr>
                ...
                <tr>
                     <td>
                        <div>
                            <span>วันที่ส่งไปรษณีย์:</span>
                        </div>
                    </td>
                     <td>
                        <asp:TextBox ID="postsend_date" runat="server" Style="width: 45%; text-align: center;"></asp:TextBox>
                    </td>
                    <td>
                    </td>
                    <td>
