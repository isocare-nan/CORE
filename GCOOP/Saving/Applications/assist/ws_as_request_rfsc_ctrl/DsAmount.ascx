<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsAmount.ascx.cs" Inherits="Saving.Applications.assist.ws_as_request_rfsc_ctrl.DsAmount" %>
                ...
                <td>
                    <table class="DataSourceFormView" style="width: 500px;">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="remark" runat="server" Width="99%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
