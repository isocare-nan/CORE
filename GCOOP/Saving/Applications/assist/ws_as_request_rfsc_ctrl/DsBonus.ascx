<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsBonus.ascx.cs" Inherits="Saving.Applications.assist.ws_as_request_rfsc_ctrl.DsBonus" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width:100%">
            ...
            <tr>
                ...
                <td colspan="6" style="width: 85%">
                    <asp:TextBox ID="check_date" runat="server" Style="text-align: left;" width="100%" ReadOnly="True"></asp:TextBox>
                </td>
            </tr>
           <%-- <tr>
            <td>
