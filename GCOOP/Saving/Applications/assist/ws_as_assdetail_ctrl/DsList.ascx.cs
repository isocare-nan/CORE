...
namespace Saving.Applications.assist.ws_as_assdetail_ctrl
{
    public partial class DsList : DataSourceRepeater
    {
        ...
        public void RetrieveList(string as_memno,string assisttype_code)
        {
            String ls_sql = "";
            ...
            ls_sql = @"
                        ...
                        where   ass.coop_id = {0} and ass.member_no = {1} and ass.assisttype_code like {2}";
            ls_sql = WebUtil.SQLFormat(ls_sql, state.SsCoopControl, as_memno,"%"+ assisttype_code+"%");
