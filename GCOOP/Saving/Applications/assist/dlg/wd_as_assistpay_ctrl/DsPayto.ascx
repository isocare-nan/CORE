...
<table class="DataSourceRepeater">
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="description" runat="server"  Style="background-color: #CCCCCC;"
    ...
    <tr>
        ...
        <td style="border-style: none;background-color:#F5FFFA; text-align: right; font-size:14px;" colspan="3" >
            <strong>รวมจำนวนเงิน</strong>
        </td>
         <td style="border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000; background-color:#F5FFFA;">
            <asp:TextBox ID="sum_pay_amt" runat="server" Style="text-align: right; 
                font-weight: bold; color:Red; font-size:12px; background-color:#F5FFFA;" ToolTip="###,###,##0.00"></asp:TextBox>
        </td>
    </tr>
</table>
