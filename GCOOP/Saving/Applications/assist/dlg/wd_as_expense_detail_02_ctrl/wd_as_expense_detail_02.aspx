<%@ Page Title="" Language="C#" MasterPageFile="~/FrameDialog.Master" AutoEventWireup="true"
    CodeBehind="wd_as_expense_detail_02.aspx.cs" Inherits="Saving.Applications.assist.dlg.wd_as_expense_detail_02_ctrl.wd_as_expense_detail_02" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function PostSubmit() {
            ...
            var member_no = dsList.GetItem(0, "member_no");

            if (cashtype == "CHQ" || cashtype == "CBT" || cashtype == "TGP") {
                if (member_no == null) {
                    alert("กรุณากรอกเบขสมาชิก!!!"); return;
            ...
            try {
                window.opener.GetValueFromDlg(bank_code, branch_code, expense_accid, pay_name, tofrom_accid, exp_clr, deptacc_no, member_no);
                window.close();
            } catch (err) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    ...
    <asp:HiddenField ID="Hd_deptaccount" runat="server" />
</asp:Content>
