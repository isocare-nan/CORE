<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.assist.dlg.wd_as_agentaccount_ctrl.DsMain" %>
    ...
    <EditItemTemplate>
        <table class="DataSourceFormView" style="width: 100%;">
            <tr>
                ...
                <td style="width:10%">
                    <asp:TextBox ID="agent_code" runat="server"></asp:TextBox>
                </td>
                <td style="width:5%">
                    <div>
