...
namespace Saving.Applications.assist.dlg.wd_as_member_search_ctrl
{
    public partial class wd_as_member_search : PageWebDialog, WebDialog
    {
        ...
        protected void BtSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((decimal)dsList.DATA.Rows[i]["resign_status"] == 1)
                {
                    dsList.FindTextBox(i, "MEMBER_NO").ForeColor = Color.Red;
                    dsList.FindTextBox(i, "FULLNAME").ForeColor = Color.Red;
                    dsList.FindTextBox(i, "FULLMEMBGROUP").ForeColor = Color.Red;
                }
                else
                {
                    dsList.FindTextBox(i, "MEMBER_NO").ForeColor = Color.Black;
                    dsList.FindTextBox(i, "FULLNAME").ForeColor = Color.Black;
                    dsList.FindTextBox(i, "FULLMEMBGROUP").ForeColor = Color.Black;
                }
            }
        }
    }
