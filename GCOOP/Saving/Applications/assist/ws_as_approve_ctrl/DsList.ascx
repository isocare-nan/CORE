...
<table cellspacing="0" rules="all" class="DataSourceRepeater" style="width: 800px;
        ...
        <td width="26%" style="text-align: center ; background-color:#FFF5EE;">
         ...
         <td width="18%" style="text-align: right;background-color:#FFF5EE;">
            ...
            <td style="border-bottom-style: solid; border-bottom-width: 2px; border-bottom-color: #000000; background-color:#FFF5EE;">
...
<div style="overflow-y: scroll; overflow-x: hidden; height: 450px; width: 800px">
   <table cellspacing="0" rules="all" class="DataSourceRepeater" style="width: 800px;
            border-collapse: collapse;">
