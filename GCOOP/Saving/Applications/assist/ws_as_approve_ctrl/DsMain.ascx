        ...
        <table class="DataSourceFormView">
            <tr>
                ...
                <td width="14%" valign="top" >
                    <asp:TextBox ID="member_no" runat="server" style="background-color:#FFFF99"></asp:TextBox>
                </td>
                ...
                <td width="30%" valign="top">
                    <asp:DropDownList ID="assisttype_code" runat="server" style="background-color:#FFFF99">
                    </asp:DropDownList>
                </td>
            ...
            <tr>
             <td width="13%" valign="top">
                    <div>
                        <span>ตั้งแต่วันที่ใบคำขอ:</span>
                    </div>
                </td>
                <td colspan="2" width="30%" valign="top">
                  <asp:TextBox ID="req_sdate" runat="server" style="background-color:#FFFF99"></asp:TextBox>
                </td>
   
                <td width="13%" valign="top">
                    <div>
                        <span>ถึงวันที่ใบคำขอ:</span>
                    </div>
                </td>
                <td width="30%" valign="top">
                    <asp:TextBox ID="req_edate" runat="server" style="background-color:#FFFF99"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td colspan="2" style="width:100%">
                    <asp:TextBox ID="conclusion_date" runat="server" style="background-color:#FFFF99"></asp:TextBox>
                </td>
                <td width="17%" valign="top">
                    <div>
                ...
                <td width="15%">
                    <asp:DropDownList ID="sort_type" runat="server">
                     <asp:ListItem Value="0" Text="--กรุณาเลือก--"></asp:ListItem>
                        <asp:ListItem Value="1" Text="เลขที่ใบคำขอ/ประเภทสวัสดิการ"></asp:ListItem>
                        <asp:ListItem Value="2" Text="ประเภทสวัสดิการ/เลขที่ใบคำขอ"></asp:ListItem>
                        <asp:ListItem Value="3" Text="ประเภทการจ่าย"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <%--<td width="20%">
