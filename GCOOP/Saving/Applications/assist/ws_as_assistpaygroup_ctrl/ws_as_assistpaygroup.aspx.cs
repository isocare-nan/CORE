    ...
    public partial class ws_as_assistpaygroup : PageWebSheet, WebSheet
    {
                       ...
                       of_initassistpay(assist);
                        ...
                        for (Int32 i = 0; i < dsSPayto.RowCount; i++)
                        {
                            ...
                            if (dsSPayto.DATA[i].MONEYTYPE_CODE == "TRN")
                            {
                                ...
                                if (dsSMain.DATA[i].send_system == "") { dsSMain.DATA[i].send_system = "DEP"; }
                                dsSPayto.DATA[i].METHPAYTYPE_CODE = dsSMain.DATA[i].send_system;
                            }
                            else
                            {
                                if (dsSPayto.DATA[i].MONEYTYPE_CODE == "TGP")
                                {
                                    dsSPayto.DATA[i].METHPAYTYPE_CODE = "TGP";
                                    dsSPayto.DATA[i].MONEYTYPE_CODE = "CBT";
                                }
                                else
                                {
        ...
        private Int32 of_postdepttran()
        {
            ...
            for (Int32 i = 0; i < dsSPayto.RowCount; i++)
            {
                ...
                ls_deptno = dsSPayto.DATA[i].DEPTACCOUNT_NO;
                ldc_payamt = dsSPayto.DATA[i].ITEMPAY_AMT;
