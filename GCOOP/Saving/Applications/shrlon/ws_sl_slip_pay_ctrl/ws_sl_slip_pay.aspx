    ...
    <script type="text/javascript">
        ...
        function OnDsDetailShareItemChanged(s, r, c, v) {
            if (c == "operate_flag") {
                ...
                var buyshare = dsMain.GetItem(0, "buyshare_amt");
                var membertype = dsMain.GetItem(0, "member_type");
                if (membertype == 2) {
                    if (buyshare > 100000) {
                        alert("เดือนนี้ซื้อหุ้นเกิน 100,000 บาทแล้ว");
                    }
                    else {
                        var aaa = 100000 - buyshare ;
                        alert("เดือนนี้สามารถซื้อหุ้นได้อีก " + aaa + " บาท");
                ...
                if (!((rkeep_int > 0 || rkeep_prin > 0) && aftermont == 1) && bfpayspec_method == 2) {
                    ...
                    if (item_payamt <= interest_payamt) {
                        ...
                        if (principalPayamt > bfshrcont_balamt) {
                            ...
                            total_itembal = bfshrcont_balamt - principal_payamt;
                        } else {
