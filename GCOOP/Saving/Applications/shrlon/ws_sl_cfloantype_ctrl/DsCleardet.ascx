            ...
            <tr>
                ...
                <td width="25%">
                    <asp:DropDownList ID="lnrcvclrfuture_type" runat="server">
                        ...
                        <asp:ListItem Value="1">หักดอกเบี้ยรับล่วงหน้า</asp:ListItem>
                        <asp:ListItem Value="2">หักงวดแรกรับล่วงหน้า</asp:ListItem>
                        <asp:ListItem Value="3">หักดอกเบี้ยล่วงหน้า ไปเงินฝาก</asp:ListItem>
                        <asp:ListItem Value="4">หักงวดแรกล่วงหน้า ไปเงินฝาก</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
                    <div>
