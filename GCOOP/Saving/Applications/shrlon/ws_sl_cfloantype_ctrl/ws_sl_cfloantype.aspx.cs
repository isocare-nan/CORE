    ...
    public partial class ws_sl_cfloantype : PageWebSheet, WebSheet
    {
        ...
        public void SaveWebSheet()
        {
            try
            {
                ...
                //dsGeneral.ResetRow();
                //dsRightdet.ResetRow();
                //dsIntdetail.ResetRow();
                //dsColldet.ResetRow();
                //dsCollreqgrt.ResetRow();
                //dsDpcancoll.ResetRow();
                //dsCollcanuse.ResetRow();
                //dsCleardet.ResetRow();
                //dsClearlist.ResetRow();
                //dsClearbuyshr.ResetRow();
                //dsDropln.ResetRow();
                //dsMbsubgrp.ResetRow();
                //dsPaymentdet.ResetRow();
                //dsPaymentlist.ResetRow();
                //dsPermdown.ResetRow();
                //dsRightcollmast.ResetRow();
                //dsRightcustom.ResetRow();
                //dsIntspc.ResetRow();
            }
            catch (Exception ex)
            {
