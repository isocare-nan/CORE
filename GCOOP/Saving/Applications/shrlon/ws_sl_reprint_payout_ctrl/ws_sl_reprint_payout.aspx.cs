    ...
    public partial class ws_sl_reprint_payout : PageWebSheet, WebSheet
    {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == PostPrint)
            {
                ...
                {
                    //PrintSlippayoutPEA(rslip);
                    if (sliptype_code != "WRT")
                    {
                        Printing.RePrintSlippayoutPEA(this, rslip, state.SsCoopControl);
                    }
                    else {
                        Printing.RePrintSlipWrt(this, rslip, state.SsCoopControl);
                    }

                }
                else {
                    PrintSlippayout(rslip);
                }
