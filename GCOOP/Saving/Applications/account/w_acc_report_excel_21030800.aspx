<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true" CodeBehind="w_acc_report_excel_21030800.aspx.cs" Inherits="Saving.Applications.account.w_acc_report_excel_21030800" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <div id="detail" runat="server">
                <dw:WebDataWindowControl ID="Dw_main1" runat="server" DataWindowObject="d_acc_report_excel_21030800_cr"
                    LibraryList="~/DataWindow/account/vc_report.pbl" AutoRestoreContext="false" AutoRestoreDataCache="true"
