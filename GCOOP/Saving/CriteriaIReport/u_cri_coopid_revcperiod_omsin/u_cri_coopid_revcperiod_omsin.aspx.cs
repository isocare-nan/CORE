...
namespace Saving.CriteriaIReport.u_cri_coopid_revcperiod_omsin
{
    public partial class u_cri_coopid_revcperiod_omsin : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_recv_s = dsMain.DATA[0].as_recv_s.Trim();
            string as_recv_e = dsMain.DATA[0].as_recv_e.Trim();
