...
namespace Saving.CriteriaIReport.u_cri_coopid_rdate_slipcode
{
    public partial class u_cri_coopid_rdate_slipcode : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                dsMain.DATA[0].recvpay_status = "8";
                dsMain.DdSlipCode();
        ...
        public void RunReport()
        {
            ...
            string slipcode = dsMain.DATA[0].slipcode;
            string recvpay_status = dsMain.DATA[0].recvpay_status;
            if (slipcode == "" || slipcode == null)
            {
                slipcode = "%";
            }
            if (recvpay_status == "8" || recvpay_status == null)
            {
                recvpay_status = "%";
            }
            ...
            try
            {
                ...
                arg.Add("as_sliptype", iReportArgumentType.String, slipcode);
                arg.Add("as_recvpay_status", iReportArgumentType.String, recvpay_status);
