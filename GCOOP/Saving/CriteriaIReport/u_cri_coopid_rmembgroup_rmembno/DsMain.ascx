<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.CriteriaIReport.u_cri_coopid_rmembgroup_rmembno.DsMain" %>
        ...
        <table class="iReportDataSourceFormView">
            ...
            <tr>
             ...
             <tr>
                <td>
                    <div>
                        <span>ตั้งแต่เลขทะเบียน:</span></div>
                </td>
                <td>
                    <asp:TextBox ID="start_membno" runat="server" Style="text-align: center"></asp:TextBox>
                </td>
            </tr>
             <tr>
                <td>
                    <div>
                        <span>ถึงเลขทะเบียน:</span></div>
                </td>
                <td>
                    <asp:TextBox ID="end_membno" runat="server" Style="text-align: center"></asp:TextBox>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
