    ...
    public partial class u_cri_coopid_rdate_rdepttype : PageWebReport, WebReport
    {
        ...
        public void WebSheetLoadBegin()
        {
            ...
            if (!IsPostBack)
            {
                ...
                string[] dtminmax = ReportUtil.GetMinMaxDepttype();
                dsMain.DATA[0].start_depttype = dtminmax[0];
                dsMain.DATA[0].end_depttype = dtminmax[1];
            }
        }
        ...
        public void RunReport()
        {
            ...
            string start_depttype = dsMain.DATA[0].start_depttype;
            string end_depttype = dsMain.DATA[0].end_depttype;
            ...
            try
            {
                ...
                arg.Add("s_date", iReportArgumentType.Date, date1);
                arg.Add("e_date", iReportArgumentType.Date, date2);
                arg.Add("s_depttype", iReportArgumentType.String, start_depttype);
                arg.Add("e_depttype", iReportArgumentType.String, end_depttype);
