...
namespace Saving.CriteriaIReport.u_cri_coopid_revcperiod_rmembgroup_krungthai
{
    public partial class u_cri_coopid_revcperiod_rmembgroup_krungthai : PageWebReport, WebReport
    {
