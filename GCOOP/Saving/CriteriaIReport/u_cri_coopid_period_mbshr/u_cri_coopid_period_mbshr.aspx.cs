...
namespace Saving.CriteriaIReport.u_cri_coopid_period_mbshr
{
    public partial class u_cri_coopid_period_mbshr : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            decimal months = 0;
            if (dsMain.DATA[0].month == 1)
            {
                months = 12;
            }
            else 
            {
                months = dsMain.DATA[0].month - 1;
            }
            int an_speriod = Convert.ToInt32(dsMain.DATA[0].year + months.ToString("00"));
            ...
            try
            {
                ...
                arg.Add("as_srecvperiod", iReportArgumentType.String, Convert.ToString(an_speriod));

                arg.Add("as_erecvperiod", iReportArgumentType.String, Convert.ToString(an_period));
