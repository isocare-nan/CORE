       ...
       <td width="20">
            ...
            <td width="120">
                <asp:DropDownList ID="loangrp1" runat="server">
                        <asp:ListItem Value="01"> ฉุกเฉิน - 10</asp:ListItem>
                        <asp:ListItem Value="02"> สามัญ - 20</asp:ListItem>
                        <asp:ListItem Value="03"> พิเศษเพื่อการเคหะสงเคราะห์ - 30</asp:ListItem>
