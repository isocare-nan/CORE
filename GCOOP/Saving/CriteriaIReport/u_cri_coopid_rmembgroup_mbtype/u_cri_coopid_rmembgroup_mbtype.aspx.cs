...
namespace Saving.CriteriaIReport.u_cri_coopid_rmembgroup_mbtype
{
    public partial class u_cri_coopid_rmembgroup_mbtype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string mbtype_code1 = "0";
            mbtype_code1 =  dsMain.DATA[0].memtype_code;
            if (mbtype_code1 == "0" || mbtype_code1 == null)
            {
                mbtype_code1 = "%";
            }
            else {
                mbtype_code1 = mbtype_code1;
            }
            ...
            try
            {
                ...
                arg.Add("as_mbtype", iReportArgumentType.String, mbtype_code1);       
