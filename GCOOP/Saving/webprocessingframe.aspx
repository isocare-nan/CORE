                ...
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    if (result != "") {  
                       if(result.indexOf("1;") >=0){
                         AddIFrameOnProcess("ประมวลผลสำเร็จ<br/>"+"รหัสทำรายการ : <%=Request["p"]%> <br/>"+getCurrentDate()+"<br/>"+((result.indexOf(".pdf") >=0)?"":result.replace("1;",""))+"<br/>"+openReport+"<br/><br/>"+closeInput);
                         ...
                         if(result.indexOf(".pdf") >=0){
                           ...
                           report_filename_url= baseURL+"/CORE/GCOOP/Saving/WSRPDF/"+report_filename;
                           try{
                            if(printer.toLowerCase()=="pdf"){
